...
public class ImportRecordServiceImpl extends GenericServiceImpl<ImportRecordDto, String> implements IImportRecordService{
    @Autowired
    private IImportRecordDao   importRecordDao;

	public BaseDao<ImportRecordDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.importRecordDao.queryImportRecordListPage(importRecordQueryBean, pagingObject);
	 }
