...
public class BankBranchServiceImpl extends GenericServiceImpl<BankBranchDto, String> implements IBankBranchService{
    @Autowired
    private IBankBranchDao   bankBranchDao;

	public BaseDao<BankBranchDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.bankBranchDao.queryBankBranchListPage(bankBranchQueryBean, pagingObject);
	 }
