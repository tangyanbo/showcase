...
public class SysOpLogServiceImpl extends GenericServiceImpl<SysOpLogDto, String> implements ISysOpLogService{
    @Autowired
    private ISysOpLogDao   sysOpLogDao;

	public BaseDao<SysOpLogDto, String> getBaseDao() {
		return sysOpLogDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.sysOpLogDao.querySysOpLogListPage(sysOpLogQueryBean, pagingObject);
	 }
