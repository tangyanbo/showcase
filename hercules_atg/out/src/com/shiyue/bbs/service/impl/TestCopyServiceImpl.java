...
public class TestCopyServiceImpl extends GenericServiceImpl<TestCopyDto, String> implements ITestCopyService{
    @Autowired
    private ITestCopyDao   testCopyDao;

	public BaseDao<TestCopyDto, String> getBaseDao() {
		return testCopyDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.testCopyDao.queryTestCopyListPage(testCopyQueryBean, pagingObject);
	 }
