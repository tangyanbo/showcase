...
@Scope("prototype")
@Service("terminalBatchConfigService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class TerminalBatchConfigServiceImpl extends GenericServiceImpl<TerminalBatchConfigDto, String> implements ITerminalBatchConfigService{
    @Autowired
    private ITerminalBatchConfigDao   terminalBatchConfigDao;

	public BaseDao<TerminalBatchConfigDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.terminalBatchConfigDao.queryTerminalBatchConfigListPage(terminalBatchConfigQueryBean, pagingObject);
	 }
