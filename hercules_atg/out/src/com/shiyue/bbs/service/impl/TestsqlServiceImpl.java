...
public class TestsqlServiceImpl extends GenericServiceImpl<TestsqlDto, String> implements ITestsqlService{
    @Autowired
    private ITestsqlDao   testsqlDao;

	public BaseDao<TestsqlDto, String> getBaseDao() {
		return testsqlDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.testsqlDao.queryTestsqlListPage(testsqlQueryBean, pagingObject);
	 }
