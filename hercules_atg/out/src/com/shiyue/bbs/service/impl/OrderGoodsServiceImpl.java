...
public class OrderGoodsServiceImpl extends GenericServiceImpl<OrderGoodsDto, String> implements IOrderGoodsService{
    @Autowired
    private IOrderGoodsDao   orderGoodsDao;

	public BaseDao<OrderGoodsDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.orderGoodsDao.queryOrderGoodsListPage(orderGoodsQueryBean, pagingObject);
	 }
