...
@Scope("prototype")
@Service("merInfoUpdateLogService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class MerInfoUpdateLogServiceImpl extends GenericServiceImpl<MerInfoUpdateLogDto, String> implements IMerInfoUpdateLogService{
    @Autowired
    private IMerInfoUpdateLogDao   merInfoUpdateLogDao;

	public BaseDao<MerInfoUpdateLogDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.merInfoUpdateLogDao.queryMerInfoUpdateLogListPage(merInfoUpdateLogQueryBean, pagingObject);
	 }
