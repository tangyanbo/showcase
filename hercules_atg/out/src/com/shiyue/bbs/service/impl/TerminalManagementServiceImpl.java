...
public class TerminalManagementServiceImpl extends GenericServiceImpl<TerminalManagementDto, String> implements ITerminalManagementService{
    @Autowired
    private ITerminalManagementDao   terminalManagementDao;

	public BaseDao<TerminalManagementDto, String> getBaseDao() {
		return terminalManagementDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.terminalManagementDao.queryTerminalManagementListPage(terminalManagementQueryBean, pagingObject);
	 }
