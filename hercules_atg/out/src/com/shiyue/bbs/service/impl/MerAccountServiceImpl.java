...
@Scope("prototype")
@Service("merAccountService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class MerAccountServiceImpl extends GenericServiceImpl<MerAccountDto, String> implements IMerAccountService{
    @Autowired
    private IMerAccountDao   merAccountDao;

	public BaseDao<MerAccountDto, String> getBaseDao() {
		return merAccountDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.merAccountDao.queryMerAccountListPage(merAccountQueryBean, pagingObject);
	 }
