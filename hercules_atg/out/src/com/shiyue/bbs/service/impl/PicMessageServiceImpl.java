...
@Scope("prototype")
@Service("picMessageService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class PicMessageServiceImpl extends GenericServiceImpl<PicMessageDto, String> implements IPicMessageService{
    @Autowired
    private IPicMessageDao   picMessageDao;

	public BaseDao<PicMessageDto, String> getBaseDao() {
		return picMessageDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.picMessageDao.queryPicMessageListPage(picMessageQueryBean, pagingObject);
	 }
