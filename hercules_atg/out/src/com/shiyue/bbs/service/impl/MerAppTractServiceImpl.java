...
@Scope("prototype")
@Service("merAppTractService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class MerAppTractServiceImpl extends GenericServiceImpl<MerAppTractDto, String> implements IMerAppTractService{
    @Autowired
    private IMerAppTractDao   merAppTractDao;

	public BaseDao<MerAppTractDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.merAppTractDao.queryMerAppTractListPage(merAppTractQueryBean, pagingObject);
	 }
