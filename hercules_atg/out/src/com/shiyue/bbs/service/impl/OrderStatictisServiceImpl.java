...
@Scope("prototype")
@Service("orderStatictisService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class OrderStatictisServiceImpl extends GenericServiceImpl<OrderStatictisDto, String> implements IOrderStatictisService{
    @Autowired
    private IOrderStatictisDao   orderStatictisDao;

	public BaseDao<OrderStatictisDto, String> getBaseDao() {
	 ...
	 */
	 ...
	 {	
		 	return this.orderStatictisDao.queryOrderStatictisListPage(orderStatictisQueryBean, pagingObject);
	 }
