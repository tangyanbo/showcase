...
public class CardBinServiceImpl extends GenericServiceImpl<CardBinDto, String> implements ICardBinService{
    @Autowired
    private ICardBinDao   cardBinDao;

	public BaseDao<CardBinDto, String> getBaseDao() {
		return cardBinDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.cardBinDao.queryCardBinListPage(cardBinQueryBean, pagingObject);
	 }
