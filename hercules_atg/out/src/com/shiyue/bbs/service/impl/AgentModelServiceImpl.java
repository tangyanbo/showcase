...
public class AgentModelServiceImpl extends GenericServiceImpl<AgentModelDto, String> implements IAgentModelService{
    @Autowired
    private IAgentModelDao   agentModelDao;

	public BaseDao<AgentModelDto, String> getBaseDao() {
		return agentModelDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.agentModelDao.queryAgentModelListPage(agentModelQueryBean, pagingObject);
	 }
