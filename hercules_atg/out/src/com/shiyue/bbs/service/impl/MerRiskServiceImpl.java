...
@Scope("prototype")
@Service("merRiskService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class MerRiskServiceImpl extends GenericServiceImpl<MerRiskDto, String> implements IMerRiskService{
    @Autowired
    private IMerRiskDao   merRiskDao;

	public BaseDao<MerRiskDto, String> getBaseDao() {
		return merRiskDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.merRiskDao.queryMerRiskListPage(merRiskQueryBean, pagingObject);
	 }
