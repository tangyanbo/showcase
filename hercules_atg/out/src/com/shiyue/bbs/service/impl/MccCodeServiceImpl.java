...
public class MccCodeServiceImpl extends GenericServiceImpl<MccCodeDto, String> implements IMccCodeService{
    @Autowired
    private IMccCodeDao   mccCodeDao;

	public BaseDao<MccCodeDto, String> getBaseDao() {
		return mccCodeDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.mccCodeDao.queryMccCodeListPage(mccCodeQueryBean, pagingObject);
	 }
