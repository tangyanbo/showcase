...
@Scope("prototype")
@Service("cardBinNewService")
@Transactional (propagation = Propagation.REQUIRED,isolation=Isolation.DEFAULT,rollbackFor=Exception.class)
public class CardBinNewServiceImpl extends GenericServiceImpl<CardBinNewDto, String> implements ICardBinNewService{
    @Autowired
    private ICardBinNewDao   cardBinNewDao;

	public BaseDao<CardBinNewDto, String> getBaseDao() {
		return cardBinNewDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.cardBinNewDao.queryCardBinNewListPage(cardBinNewQueryBean, pagingObject);
	 }
