...
public class BlackInfoServiceImpl extends GenericServiceImpl<BlackInfoDto, String> implements IBlackInfoService{
    @Autowired
    private IBlackInfoDao   blackInfoDao;

	public BaseDao<BlackInfoDto, String> getBaseDao() {
		return blackInfoDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.blackInfoDao.queryBlackInfoListPage(blackInfoQueryBean, pagingObject);
	 }
