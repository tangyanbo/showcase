...
public class SysModelServiceImpl extends GenericServiceImpl<SysModelDto, String> implements ISysModelService{
    @Autowired
    private ISysModelDao   sysModelDao;

	public BaseDao<SysModelDto, String> getBaseDao() {
		return sysModelDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.sysModelDao.querySysModelListPage(sysModelQueryBean, pagingObject);
	 }
