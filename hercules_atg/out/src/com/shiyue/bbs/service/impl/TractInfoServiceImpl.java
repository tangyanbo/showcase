...
public class TractInfoServiceImpl extends GenericServiceImpl<TractInfoDto, String> implements ITractInfoService{
    @Autowired
    private ITractInfoDao   tractInfoDao;

	public BaseDao<TractInfoDto, String> getBaseDao() {
		return tractInfoDao;
	}
	 ...
	 */
	 ...
	 {	
		 	return this.tractInfoDao.queryTractInfoListPage(tractInfoQueryBean, pagingObject);
	 }
