...
@Controller("delMerSettleStatictisAction")
@Scope("prototype")
public class DelMerSettleStatictisAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			merSettleStatictisService.deletePK(paramMerSettleStatictisDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
