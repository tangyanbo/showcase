...
@Controller("delFaiPayInfoBackTestAction")
@Scope("prototype")
public class DelFaiPayInfoBackTestAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			faiPayInfoBackTestService.deletePK(paramFaiPayInfoBackTestDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
