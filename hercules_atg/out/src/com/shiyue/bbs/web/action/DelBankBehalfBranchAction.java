...
@Controller("delBankBehalfBranchAction")
@Scope("prototype")
public class DelBankBehalfBranchAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			bankBehalfBranchService.deletePK(paramBankBehalfBranchDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
