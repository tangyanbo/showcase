...
@Controller("delSubMerSignSettleProfitAction")
@Scope("prototype")
public class DelSubMerSignSettleProfitAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			subMerSignSettleProfitService.deletePK(paramSubMerSignSettleProfitDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
