...
@Controller("detailTerminalTypePage")
@Scope("prototype")
public class DetailTerminalTypePage extends BaseAction {
	...
	public String execute() throws Exception {
		try {
		    TerminalTypeDto paramTerminalTypeDto = new TerminalTypeDto();
		//设置主键
			paramTerminalTypeDto.setProduct_id(pkid);
			terminalTypeDto = terminalTypeService.getRow(paramTerminalTypeDto );
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
