...
@Controller("delFaiOrderInfoV2BackTestAction")
@Scope("prototype")
public class DelFaiOrderInfoV2BackTestAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			faiOrderInfoV2BackTestService.deletePK(paramFaiOrderInfoV2BackTestDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
