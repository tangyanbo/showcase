...
@Controller("delV2BankBehalfTransDetailAction")
@Scope("prototype")
public class DelV2BankBehalfTransDetailAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			v2BankBehalfTransDetailService.deletePK(paramV2BankBehalfTransDetailDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
