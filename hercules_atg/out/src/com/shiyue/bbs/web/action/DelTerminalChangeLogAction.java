...
@Controller("delTerminalChangeLogAction")
@Scope("prototype")
public class DelTerminalChangeLogAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			terminalChangeLogService.deletePK(paramTerminalChangeLogDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
