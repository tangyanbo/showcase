...
@Controller("addFaiOrderInfoV2BackTestAction")
@Scope("prototype")
public class AddFaiOrderInfoV2BackTestAction extends BaseAction {
	...
	public String execute() throws Exception {
		try {
			faiOrderInfoV2BackTestService.save(faiOrderInfoV2BackTestDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
