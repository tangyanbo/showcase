...
@Controller("editTestAction")
@Scope("prototype")
public class EditTestAction extends BaseAction {
	...
	public String execute() throws Exception {
		try {
		      ...
		      TestDto tmpTestDto = new TestDto();
			  tmpTestDto.setId(testDto.getId());
			  tmpTestDto.setTsn(testDto.getTsn());
		
			testService.updatePK(testDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
