...
@Controller("detailAgentManagerPage")
@Scope("prototype")
public class DetailAgentManagerPage extends BaseAction {
	...
	//出参
	private AgentManagerDto agentManagerDto;
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			agentManagerDto = agentManagerService.getRow(paramAgentManagerDto );
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
