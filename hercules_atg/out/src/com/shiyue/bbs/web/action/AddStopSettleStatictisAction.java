...
@Controller("addStopSettleStatictisAction")
@Scope("prototype")
public class AddStopSettleStatictisAction extends BaseAction {
	...
	public String execute() throws Exception {
		try {
			stopSettleStatictisService.save(stopSettleStatictisDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
