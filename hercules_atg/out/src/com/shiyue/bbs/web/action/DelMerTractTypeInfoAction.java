...
@Controller("delMerTractTypeInfoAction")
@Scope("prototype")
public class DelMerTractTypeInfoAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			merTractTypeInfoService.deletePK(paramMerTractTypeInfoDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
