...
@Controller("delStopSettleStatictisAction")
@Scope("prototype")
public class DelStopSettleStatictisAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			stopSettleStatictisService.deletePK(paramStopSettleStatictisDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
