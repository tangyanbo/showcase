...
@Controller("delTerminalBatchConfigAction")
@Scope("prototype")
public class DelTerminalBatchConfigAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			terminalBatchConfigService.deletePK(paramTerminalBatchConfigDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
