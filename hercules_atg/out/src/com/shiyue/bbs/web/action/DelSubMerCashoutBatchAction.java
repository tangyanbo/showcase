...
@Controller("delSubMerCashoutBatchAction")
@Scope("prototype")
public class DelSubMerCashoutBatchAction extends BaseAction {
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			subMerCashoutBatchService.deletePK(paramSubMerCashoutBatchDto);
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
