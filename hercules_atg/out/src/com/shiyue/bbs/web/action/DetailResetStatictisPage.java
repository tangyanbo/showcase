...
@Controller("detailResetStatictisPage")
@Scope("prototype")
public class DetailResetStatictisPage extends BaseAction {
	...
	//出参
	private ResetStatictisDto resetStatictisDto;

	
	public String execute() throws Exception {
		try {
		    ResetStatictisDto paramResetStatictisDto = new ResetStatictisDto();
		//设置主键
			paramResetStatictisDto.setId(pkid);
			resetStatictisDto = resetStatictisService.getRow(paramResetStatictisDto );
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
