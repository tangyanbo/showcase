...
@Controller("detailOrderInfoBakPage")
@Scope("prototype")
public class DetailOrderInfoBakPage extends BaseAction {
	...
	//出参
	private OrderInfoBakDto orderInfoBakDto;
	...
	public String execute() throws Exception {
		...
		//设置主键
			...
			orderInfoBakDto = orderInfoBakService.getRow(paramOrderInfoBakDto );
			return SUCCESS;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
