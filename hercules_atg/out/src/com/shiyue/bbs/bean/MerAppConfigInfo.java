...
@EntityPK(Pk = "id", defaultColumn = false, tableName = "MER_APP_CONFIG_INFO")
@AddParentClass(AddParentClass = true, DefaultValueClass = Constant.DEFAULT_COLUMN_DEFAULT_CLASEENAME)
public class MerAppConfigInfoDto  extends BaseDtoImpl{//
	private java.lang.Long id;//
	private java.lang.Long app_id;//
	...
	* @return
	*/
	public java.lang.Long getApp_id() {
		return app_id;
	}
	...
	* @param app_id
	*/
 	public void setApp_id(java.lang.Long app_id) {
		this.app_id = app_id;
	}
   /**
	* 获取 
