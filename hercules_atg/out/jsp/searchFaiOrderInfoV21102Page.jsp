...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiOrderInfoV21102" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	faiOrderInfoV21102_list.buildQueryParams=function(){
	    $('#dg_faiOrderInfoV21102').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		faiOrderInfoV21102_list.buildQueryParams();
		$('#dg_faiOrderInfoV21102').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiOrderInfoV21102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_ORDER_INFO_V2_1102',
		    width: 800,
		    height: 500,
		    href: 'addFaiOrderInfoV21102Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiOrderInfoV21102From').form({   
						 url:'addFaiOrderInfoV21102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiOrderInfoV21102_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiOrderInfoV21102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiOrderInfoV21102',
		    width: 800,
		    height: 500,
		    href: 'editFaiOrderInfoV21102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiOrderInfoV21102From').form({   
						 url:'editFaiOrderInfoV21102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiOrderInfoV21102From').form({   
						 url:'delFaiOrderInfoV21102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delFaiOrderInfoV21102From').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	faiOrderInfoV21102_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiOrderInfoV21102',
		    width: 800,
		    height: 500,
		    href: 'detailFaiOrderInfoV21102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
