...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_bankBranchTest" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	bankBranchTest_list.buildQueryParams=function(){
	    $('#dg_bankBranchTest').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		bankBranchTest_list.buildQueryParams();
		$('#dg_bankBranchTest').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addBankBranchTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'BANK_BRANCH_TEST',
		    width: 800,
		    height: 500,
		    href: 'addBankBranchTestPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addBankBranchTestFrom').form({   
						 url:'addBankBranchTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	bankBranchTest_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editBankBranchTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'BankBranchTest',
		    width: 800,
		    height: 500,
		    href: 'editBankBranchTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editBankBranchTestFrom').form({   
						 url:'editBankBranchTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delBankBranchTestFrom').form({   
						 url:'delBankBranchTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	bankBranchTest_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细BankBranchTest',
		    width: 800,
		    height: 500,
		    href: 'detailBankBranchTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
