...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_sucOrderInfoV2" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	sucOrderInfoV2_list.buildQueryParams=function(){
	    $('#dg_sucOrderInfoV2').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		sucOrderInfoV2_list.buildQueryParams();
		$('#dg_sucOrderInfoV2').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addSucOrderInfoV2From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SUC_ORDER_INFO_V2',
		    width: 800,
		    height: 500,
		    href: 'addSucOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addSucOrderInfoV2From').form({   
						 url:'addSucOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	sucOrderInfoV2_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editSucOrderInfoV2From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SucOrderInfoV2',
		    width: 800,
		    height: 500,
		    href: 'editSucOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editSucOrderInfoV2From').form({   
						 url:'editSucOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delSucOrderInfoV2From').form({   
						 url:'delSucOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	sucOrderInfoV2_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细SucOrderInfoV2',
		    width: 800,
		    height: 500,
		    href: 'detailSucOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
