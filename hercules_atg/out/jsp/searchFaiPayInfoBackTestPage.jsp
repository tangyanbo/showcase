...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiPayInfoBackTest" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	faiPayInfoBackTest_list.buildQueryParams=function(){
	    $('#dg_faiPayInfoBackTest').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		faiPayInfoBackTest_list.buildQueryParams();
		$('#dg_faiPayInfoBackTest').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiPayInfoBackTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_PAY_INFO_BACK_TEST',
		    width: 800,
		    height: 500,
		    href: 'addFaiPayInfoBackTestPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiPayInfoBackTestFrom').form({   
						 url:'addFaiPayInfoBackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiPayInfoBackTest_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiPayInfoBackTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiPayInfoBackTest',
		    width: 800,
		    height: 500,
		    href: 'editFaiPayInfoBackTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiPayInfoBackTestFrom').form({   
						 url:'editFaiPayInfoBackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiPayInfoBackTestFrom').form({   
						 url:'delFaiPayInfoBackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delFaiPayInfoBackTestFrom').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	faiPayInfoBackTest_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiPayInfoBackTest',
		    width: 800,
		    height: 500,
		    href: 'detailFaiPayInfoBackTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
