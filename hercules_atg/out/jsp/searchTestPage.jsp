...
jQuery(function($){
	//定义构造查询
	test_list.buildQueryParams=function(){
	    $('#dg_test').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		test_list.buildQueryParams();
		$('#dg_test').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'TEST',
		    width: 800,
		    height: 500,
		    href: 'addTestPage.action',
		    modal: true,
		    method: "POST",
	...
	//更新
	test_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'Test',
		    width: 800,
		    height: 500,
		    href: 'editTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
	...
	//详细
	test_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细Test',
		    width: 800,
		    height: 500,
		    href: 'detailTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
