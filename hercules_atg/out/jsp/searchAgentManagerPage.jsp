...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_agentManager" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	agentManager_list.buildQueryParams=function(){
	    $('#dg_agentManager').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		agentManager_list.buildQueryParams();
		$('#dg_agentManager').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addAgentManagerFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'AGENT_MANAGER',
		    width: 800,
		    height: 500,
		    href: 'addAgentManagerPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addAgentManagerFrom').form({   
						 url:'addAgentManagerAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	agentManager_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editAgentManagerFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'AgentManager',
		    width: 800,
		    height: 500,
		    href: 'editAgentManagerPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editAgentManagerFrom').form({   
						 url:'editAgentManagerAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delAgentManagerFrom').form({   
						 url:'delAgentManagerAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	agentManager_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细AgentManager',
		    width: 800,
		    height: 500,
		    href: 'detailAgentManagerPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
