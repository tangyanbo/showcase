...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_sucPayInfoNew1102" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	sucPayInfoNew1102_list.buildQueryParams=function(){
	    $('#dg_sucPayInfoNew1102').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		sucPayInfoNew1102_list.buildQueryParams();
		$('#dg_sucPayInfoNew1102').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addSucPayInfoNew1102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SUC_PAY_INFO_NEW_1102',
		    width: 800,
		    height: 500,
		    href: 'addSucPayInfoNew1102Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addSucPayInfoNew1102From').form({   
						 url:'addSucPayInfoNew1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	sucPayInfoNew1102_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editSucPayInfoNew1102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SucPayInfoNew1102',
		    width: 800,
		    height: 500,
		    href: 'editSucPayInfoNew1102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editSucPayInfoNew1102From').form({   
						 url:'editSucPayInfoNew1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delSucPayInfoNew1102From').form({   
						 url:'delSucPayInfoNew1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delSucPayInfoNew1102From').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	sucPayInfoNew1102_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细SucPayInfoNew1102',
		    width: 800,
		    height: 500,
		    href: 'detailSucPayInfoNew1102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
