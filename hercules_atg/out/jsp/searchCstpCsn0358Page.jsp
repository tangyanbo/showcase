...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_cstpCsn0358" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	cstpCsn0358_list.buildQueryParams=function(){
	    $('#dg_cstpCsn0358').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		cstpCsn0358_list.buildQueryParams();
		$('#dg_cstpCsn0358').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addCstpCsn0358From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CSTP_CSN_0358',
		    width: 800,
		    height: 500,
		    href: 'addCstpCsn0358Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addCstpCsn0358From').form({   
						 url:'addCstpCsn0358Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	cstpCsn0358_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editCstpCsn0358From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CstpCsn0358',
		    width: 800,
		    height: 500,
		    href: 'editCstpCsn0358Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editCstpCsn0358From').form({   
						 url:'editCstpCsn0358Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delCstpCsn0358From').form({   
						 url:'delCstpCsn0358Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	cstpCsn0358_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细CstpCsn0358',
		    width: 800,
		    height: 500,
		    href: 'detailCstpCsn0358Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
