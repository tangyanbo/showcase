...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_cstpCsn0365" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	cstpCsn0365_list.buildQueryParams=function(){
	    $('#dg_cstpCsn0365').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		cstpCsn0365_list.buildQueryParams();
		$('#dg_cstpCsn0365').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addCstpCsn0365From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CSTP_CSN_0365',
		    width: 800,
		    height: 500,
		    href: 'addCstpCsn0365Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addCstpCsn0365From').form({   
						 url:'addCstpCsn0365Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	cstpCsn0365_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editCstpCsn0365From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CstpCsn0365',
		    width: 800,
		    height: 500,
		    href: 'editCstpCsn0365Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editCstpCsn0365From').form({   
						 url:'editCstpCsn0365Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delCstpCsn0365From').form({   
						 url:'delCstpCsn0365Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	cstpCsn0365_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细CstpCsn0365',
		    width: 800,
		    height: 500,
		    href: 'detailCstpCsn0365Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
