...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_merTractTypeInfo" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	merTractTypeInfo_list.buildQueryParams=function(){
	    $('#dg_merTractTypeInfo').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		merTractTypeInfo_list.buildQueryParams();
		$('#dg_merTractTypeInfo').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addMerTractTypeInfoFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'MER_TRACT_TYPE_INFO',
		    width: 800,
		    height: 500,
		    href: 'addMerTractTypeInfoPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addMerTractTypeInfoFrom').form({   
						 url:'addMerTractTypeInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	merTractTypeInfo_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editMerTractTypeInfoFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'MerTractTypeInfo',
		    width: 800,
		    height: 500,
		    href: 'editMerTractTypeInfoPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editMerTractTypeInfoFrom').form({   
						 url:'editMerTractTypeInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delMerTractTypeInfoFrom').form({   
						 url:'delMerTractTypeInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delMerTractTypeInfoFrom').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	merTractTypeInfo_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细MerTractTypeInfo',
		    width: 800,
		    height: 500,
		    href: 'detailMerTractTypeInfoPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
