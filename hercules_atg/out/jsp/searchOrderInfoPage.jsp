...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_orderInfo" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	orderInfo_list.buildQueryParams=function(){
	    $('#dg_orderInfo').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		orderInfo_list.buildQueryParams();
		$('#dg_orderInfo').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addOrderInfoFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'ORDER_INFO',
		    width: 800,
		    height: 500,
		    href: 'addOrderInfoPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addOrderInfoFrom').form({   
						 url:'addOrderInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	orderInfo_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editOrderInfoFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'OrderInfo',
		    width: 800,
		    height: 500,
		    href: 'editOrderInfoPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editOrderInfoFrom').form({   
						 url:'editOrderInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delOrderInfoFrom').form({   
						 url:'delOrderInfoAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	orderInfo_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细OrderInfo',
		    width: 800,
		    height: 500,
		    href: 'detailOrderInfoPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
