...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_cstpCsn" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	cstpCsn_list.buildQueryParams=function(){
	    $('#dg_cstpCsn').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		cstpCsn_list.buildQueryParams();
		$('#dg_cstpCsn').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addCstpCsnFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CSTP_CSN',
		    width: 800,
		    height: 500,
		    href: 'addCstpCsnPage.action',
		    modal: true,
		    method: "POST",
	...
	//更新
	cstpCsn_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editCstpCsnFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CstpCsn',
		    width: 800,
		    height: 500,
		    href: 'editCstpCsnPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editCstpCsnFrom').form({   
						 url:'editCstpCsnAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	cstpCsn_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细CstpCsn',
		    width: 800,
		    height: 500,
		    href: 'detailCstpCsnPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
