...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_orderInfo1" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	orderInfo1_list.buildQueryParams=function(){
	    $('#dg_orderInfo1').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		orderInfo1_list.buildQueryParams();
		$('#dg_orderInfo1').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addOrderInfo1From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'ORDER_INFO1',
		    width: 800,
		    height: 500,
		    href: 'addOrderInfo1Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addOrderInfo1From').form({   
						 url:'addOrderInfo1Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	orderInfo1_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editOrderInfo1From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'OrderInfo1',
		    width: 800,
		    height: 500,
		    href: 'editOrderInfo1Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editOrderInfo1From').form({   
						 url:'editOrderInfo1Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delOrderInfo1From').form({   
						 url:'delOrderInfo1Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	orderInfo1_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细OrderInfo1',
		    width: 800,
		    height: 500,
		    href: 'detailOrderInfo1Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
