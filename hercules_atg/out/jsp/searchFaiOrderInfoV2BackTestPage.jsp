...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiOrderInfoV2BackTest" class="easyui-datagrid" 
...
<script>
var faiOrderInfoV2BackTest_list ={};
var toolbar = [{
				id : 'search_btn',
				text : '查询',
				iconCls : 'icon-search'
...
jQuery(function($){
	//定义构造查询
	faiOrderInfoV2BackTest_list.buildQueryParams=function(){
	    $('#dg_faiOrderInfoV2BackTest').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		faiOrderInfoV2BackTest_list.buildQueryParams();
		$('#dg_faiOrderInfoV2BackTest').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiOrderInfoV2BackTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_ORDER_INFO_V2_BACK_TEST',
		    width: 800,
		    height: 500,
		    href: 'addFaiOrderInfoV2BackTestPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiOrderInfoV2BackTestFrom').form({   
						 url:'addFaiOrderInfoV2BackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiOrderInfoV2BackTest_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiOrderInfoV2BackTestFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiOrderInfoV2BackTest',
		    width: 800,
		    height: 500,
		    href: 'editFaiOrderInfoV2BackTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiOrderInfoV2BackTestFrom').form({   
						 url:'editFaiOrderInfoV2BackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiOrderInfoV2BackTestFrom').form({   
						 url:'delFaiOrderInfoV2BackTestAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delFaiOrderInfoV2BackTestFrom').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	faiOrderInfoV2BackTest_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiOrderInfoV2BackTest',
		    width: 800,
		    height: 500,
		    href: 'detailFaiOrderInfoV2BackTestPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
