...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_cstpCsn0013" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	cstpCsn0013_list.buildQueryParams=function(){
	    $('#dg_cstpCsn0013').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		cstpCsn0013_list.buildQueryParams();
		$('#dg_cstpCsn0013').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addCstpCsn0013From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CSTP_CSN_0013',
		    width: 800,
		    height: 500,
		    href: 'addCstpCsn0013Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addCstpCsn0013From').form({   
						 url:'addCstpCsn0013Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	cstpCsn0013_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editCstpCsn0013From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'CstpCsn0013',
		    width: 800,
		    height: 500,
		    href: 'editCstpCsn0013Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editCstpCsn0013From').form({   
						 url:'editCstpCsn0013Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delCstpCsn0013From').form({   
						 url:'delCstpCsn0013Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	cstpCsn0013_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细CstpCsn0013',
		    width: 800,
		    height: 500,
		    href: 'detailCstpCsn0013Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
