...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_payInfo1029" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	payInfo1029_list.buildQueryParams=function(){
	    $('#dg_payInfo1029').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		payInfo1029_list.buildQueryParams();
		$('#dg_payInfo1029').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addPayInfo1029From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'PAY_INFO_1029',
		    width: 800,
		    height: 500,
		    href: 'addPayInfo1029Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addPayInfo1029From').form({   
						 url:'addPayInfo1029Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	payInfo1029_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editPayInfo1029From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'PayInfo1029',
		    width: 800,
		    height: 500,
		    href: 'editPayInfo1029Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editPayInfo1029From').form({   
						 url:'editPayInfo1029Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delPayInfo1029From').form({   
						 url:'delPayInfo1029Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	payInfo1029_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细PayInfo1029',
		    width: 800,
		    height: 500,
		    href: 'detailPayInfo1029Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
