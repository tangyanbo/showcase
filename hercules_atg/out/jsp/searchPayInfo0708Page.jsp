...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_payInfo0708" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	payInfo0708_list.buildQueryParams=function(){
	    $('#dg_payInfo0708').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		payInfo0708_list.buildQueryParams();
		$('#dg_payInfo0708').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addPayInfo0708From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'PAY_INFO_0708',
		    width: 800,
		    height: 500,
		    href: 'addPayInfo0708Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addPayInfo0708From').form({   
						 url:'addPayInfo0708Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	payInfo0708_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editPayInfo0708From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'PayInfo0708',
		    width: 800,
		    height: 500,
		    href: 'editPayInfo0708Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editPayInfo0708From').form({   
						 url:'editPayInfo0708Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delPayInfo0708From').form({   
						 url:'delPayInfo0708Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	payInfo0708_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细PayInfo0708',
		    width: 800,
		    height: 500,
		    href: 'detailPayInfo0708Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
