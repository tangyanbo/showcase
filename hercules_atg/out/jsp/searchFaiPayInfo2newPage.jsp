...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiPayInfo2new" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	faiPayInfo2new_list.buildQueryParams=function(){
	    $('#dg_faiPayInfo2new').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		faiPayInfo2new_list.buildQueryParams();
		$('#dg_faiPayInfo2new').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiPayInfo2newFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_PAY_INFO_2NEW',
		    width: 800,
		    height: 500,
		    href: 'addFaiPayInfo2newPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiPayInfo2newFrom').form({   
						 url:'addFaiPayInfo2newAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiPayInfo2new_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiPayInfo2newFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiPayInfo2new',
		    width: 800,
		    height: 500,
		    href: 'editFaiPayInfo2newPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiPayInfo2newFrom').form({   
						 url:'editFaiPayInfo2newAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiPayInfo2newFrom').form({   
						 url:'delFaiPayInfo2newAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	faiPayInfo2new_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiPayInfo2new',
		    width: 800,
		    height: 500,
		    href: 'detailFaiPayInfo2newPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
