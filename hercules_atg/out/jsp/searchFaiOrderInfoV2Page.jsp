...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiOrderInfoV2" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	faiOrderInfoV2_list.buildQueryParams=function(){
	    $('#dg_faiOrderInfoV2').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		faiOrderInfoV2_list.buildQueryParams();
		$('#dg_faiOrderInfoV2').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiOrderInfoV2From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_ORDER_INFO_V2',
		    width: 800,
		    height: 500,
		    href: 'addFaiOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiOrderInfoV2From').form({   
						 url:'addFaiOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiOrderInfoV2_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiOrderInfoV2From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiOrderInfoV2',
		    width: 800,
		    height: 500,
		    href: 'editFaiOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiOrderInfoV2From').form({   
						 url:'editFaiOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiOrderInfoV2From').form({   
						 url:'delFaiOrderInfoV2Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	faiOrderInfoV2_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiOrderInfoV2',
		    width: 800,
		    height: 500,
		    href: 'detailFaiOrderInfoV2Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
