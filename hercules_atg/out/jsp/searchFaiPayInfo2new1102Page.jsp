...
<body class="easyui-layout">
			...
			<div class="easyui-panel" title="查询条件" style="padding:5px;height:120px;margin: 0px;" data-options="region:'north'">
				<form id="searchForm" name="searchForm" method="post" >
					<table cellpadding="5">
								...
								<td>modify_date</td>
								<td>
									<input type="text" id="search_modify_date" name="search_modify_date" class="easyui-textbox" value="${search_modify_date}"/>
								</td>
								<td>entry_mode</td>
								<td>
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_faiPayInfo2new1102" class="easyui-datagrid" 
					...
					<thead>
						<tr>
							...
							<th data-options="field:'MODIFY_DATE',width:120,sortable:'true',align:'left'">modify_date</th>
...
jQuery(function($){
	//定义构造查询
	faiPayInfo2new1102_list.buildQueryParams=function(){
	    $('#dg_faiPayInfo2new1102').datagrid({
			queryParams: {
						 ...
						 'search_modify_date':$("input[name='search_modify_date']").val(),
	...
	$('#search_btn').click(function(){
		faiPayInfo2new1102_list.buildQueryParams();
		$('#dg_faiPayInfo2new1102').datagrid('load');
	});
	...
	$('#clear_btn').click(function(){
		//清空查询条件
			...
			$("input[name='search_modify_date']").val("");
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addFaiPayInfo2new1102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FAI_PAY_INFO_2NEW_1102',
		    width: 800,
		    height: 500,
		    href: 'addFaiPayInfo2new1102Page.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addFaiPayInfo2new1102From').form({   
						 url:'addFaiPayInfo2new1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	faiPayInfo2new1102_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editFaiPayInfo2new1102From';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'FaiPayInfo2new1102',
		    width: 800,
		    height: 500,
		    href: 'editFaiPayInfo2new1102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editFaiPayInfo2new1102From').form({   
						 url:'editFaiPayInfo2new1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delFaiPayInfo2new1102From').form({   
						 url:'delFaiPayInfo2new1102Action.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
					    ...
					    $('#delFaiPayInfo2new1102From').submit();
		    	}
		     }
		    ,{
		    	text: "取 消",
	...
	//详细
	faiPayInfo2new1102_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细FaiPayInfo2new1102',
		    width: 800,
		    height: 500,
		    href: 'detailFaiPayInfo2new1102Page.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
