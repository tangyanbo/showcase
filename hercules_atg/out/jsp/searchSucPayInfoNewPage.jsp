...
<body class="easyui-layout">
			...
			<div class="easyui-panel" style="padding:0px;margin: 0px;" data-options="region:'center'">
				<table  id="dg_sucPayInfoNew" class="easyui-datagrid" 
...
jQuery(function($){
	//定义构造查询
	sucPayInfoNew_list.buildQueryParams=function(){
	    $('#dg_sucPayInfoNew').datagrid({
			queryParams: {
	...
	$('#search_btn').click(function(){
		sucPayInfoNew_list.buildQueryParams();
		$('#dg_sucPayInfoNew').datagrid('load');
	});
	...
	$('#add_btn').click(function(){
		var add_form_id ='#addSucPayInfoNewFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SUC_PAY_INFO_NEW',
		    width: 800,
		    height: 500,
		    href: 'addSucPayInfoNewPage.action',
		    modal: true,
		    method: "POST",
		    ...
		    buttons: [{
		    	text: "提  交",
		    	handler: function(e){
		    		$('#addSucPayInfoNewFrom').form({   
						 url:'addSucPayInfoNewAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
	...
	//更新
	sucPayInfoNew_list.updateFormSubmit = function(pkid){
	    var edit_form_id ='#editSucPayInfoNewFrom';
		$('<div id="dialog_holder"></div>').dialog({
		    title: 'SucPayInfoNew',
		    width: 800,
		    height: 500,
		    href: 'editSucPayInfoNewPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
		    ...
		    buttons: [{
		    	text: "保  存",
		    	handler: function(e){
		   				$('#editSucPayInfoNewFrom').form({   
						 url:'editSucPayInfoNewAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
		    ...
		    ,{
		    	text: "删  除",
		     	handler: function(e){
		     			$('#delSucPayInfoNewFrom').form({   
						 url:'delSucPayInfoNewAction.action',    
							     onSubmit: function(){
							       $.messager.progress(); 
							        // do some check       
							        // return false to prevent submit;    
	...
	//详细
	sucPayInfoNew_list.detailFormSubmit = function(pkid){
		$('<div id="dialog_holder"></div>').dialog({
		    title: '详细SucPayInfoNew',
		    width: 800,
		    height: 500,
		    href: 'detailSucPayInfoNewPage.action',
		    modal: true,
		    method: "POST",
		    params:{pkid:pkid},
		    extractor: function(data){
