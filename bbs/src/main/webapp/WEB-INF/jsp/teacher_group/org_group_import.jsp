...
<body>
<form action="importOrgGroup.action" method="post" enctype="multipart/form-data">
		<div class="operate">
			<a class="icon_download" href="downloadOrgGroupTemplate.action">下载部门分组模板</a>
			<a class="icon_back" href="<c:url value="/toOrgGroup.action"/>">返回</a>
		</div>
	<div id="content">
		...
		<div>
			<span class="icon_explain">部门和帐号字段必须填写。</span>
		</div>
	</div>
</form>
</body>
