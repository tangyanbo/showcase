...
<body>
<form action="importGradeGroup.action" method="post" enctype="multipart/form-data">
		<div class="operate">
			<a class="icon_download" href="downloadGradeGroupTemplate.action">下载年级分组模板</a>
			<a class="icon_back" href="<c:url value="/toGradeGroup.action"/>">返回</a>
		</div>
	<div id="content">
		...
		<div>
			<span class="icon_explain">年级和帐号字段必须填写。</span>
		</div>
	</div>
</form>
</body>
