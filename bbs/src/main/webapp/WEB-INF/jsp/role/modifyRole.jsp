...
<script type="text/javascript">
	$(function(){
		...
		//加载权限树
		$.getJSON("getCategoryListCheckedJson.action",{"role.roleId":"${role.roleId}"},function(nodes){
        ...
        <div class="jsMain">
            <div class="jsLeft">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table0">
                  <tr>
                    <td colspan="2" class="tddeeefd"><strong>修改角色</strong></td>
                  </tr>
                  <tr>
